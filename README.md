...
- 複数タブ、ブックマークタブを先頭にまとめて表示し上下配置・長押し削除に対応するタブバー、選択可能な起動画面、ブックマーク、履歴、未読管理、閲覧位置の保存、未読合計を表示するホーム画面ウィジェット
...
- ピュアホワイト／ピュアダークを含むライト／ダーク対応のテーマ、作成・共有・バックアップできるカスタムテーマ、検索・タイトルバーの配置や終了確認を含む画面・ジェスチャー設定
