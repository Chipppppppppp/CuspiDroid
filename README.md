...
- 通常・AI判定・返信警告別に表示／ぼかし／非表示を選べる画像・GIF・動画のプレビューと拡大、ImgBBへのアップロード
- ピュアホワイト／ピュアダークを含むライト／ダーク対応のテーマ、作成・共有・バックアップできるカスタムテーマ、カテゴリ別に検索できる設定、検索・タイトルバーの配置とタブバーの非表示／上／下を選べる画面・ジェスチャー設定
