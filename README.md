...
- 長辺を基準に専用の正方形セル内へ全体が収まる画像・GIF・動画の共通プレビューと全画面ズーム、スレ内メディア間の左右スワイプ移動、グロ・糞便・性的内容などの不適切画像を単一の端末内AIモデルで一括判定する共通ぼかしと表示前の注意ダイアログ、ImgBBへのアップロードと同じ比率で縮小表示するアップロード履歴と、他のポップアップと統一した削除確認ダイアログ
...
CuspiDroid は GNU General Public License v3.0 の下で配布されています。詳細は [LICENSE](LICENSE) を参照してください。バンドルしている第三者製AIモデルの帰属とライセンスは [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) に記載しています。
