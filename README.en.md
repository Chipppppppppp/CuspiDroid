...
- Multiple tabs with progressive tab and bookmark overview display, an optional top-or-bottom tab bar that includes unloaded bookmarks in the same order as the tab overview and supports long-press removal, startup choices of last page, tab overview, or new tab, bookmarks, histories, unread tracking, saved reading positions, and a home-screen widget showing total unread posts
