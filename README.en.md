...
- Multiple tabs, an optional top-or-bottom tab bar that places bookmark tabs first and supports long-press closing, selectable startup pages, bookmarks, histories, unread tracking, saved reading positions, and a home-screen widget showing total unread posts
