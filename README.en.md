...
- Native board and thread views for 5ch and custom BBS sites, with pull-to-refresh. Board loading is isolated from other background I/O, custom BBS lists such as Edge render incrementally in small batches, and returning from a thread to an uncached board switches immediately to its loading screen
