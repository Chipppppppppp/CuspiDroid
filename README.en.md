...
- Shared square-contained image, GIF, and video previews with full-screen zoom, graphic-image blur detection, ImgBB uploads, and upload history with expandable thumbnails
