...
- Tree view, reply/link/popular-post filters with an editable popularity threshold, automatic AA detection for bodies of at least four nonblank lines by scoring repeated leading whitespace, punctuation, quotation marks, and box-drawing characters plus repeated in-line whitespace and requiring a per-line score above 0.8, AA rendering, repeated-copy omission, distinct colored left bars for your posts and replies to them, and board-scoped NGWord/NGName/NGID rules
