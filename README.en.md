...
- Purpose-based settings cards with icons; Storage shows current usage, while cache deletion uses a dedicated red action and a confirmation that states the amount and scope
