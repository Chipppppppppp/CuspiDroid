...
- Native board and thread views for 5ch and custom BBS sites, with pull-to-refresh. Board loading is isolated from other background I/O to reduce wait times on sites such as Edge
