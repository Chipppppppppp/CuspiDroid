...
- Combined URL and search address bar with thread search through `find.5ch.io` or a custom URL. If `find.5ch.io` returns HTTP 502 for a query with no matches, the app displays "No search results" instead
